...
################################################################################ Tab3 (inicio)
        ...
        self.pbMostrarGrafo = QPushButton(self.tab3)
        self.pbMostrarGrafo.setText(u"Mostrar")
        self.pbMostrarGrafo.setObjectName(u"pbMostrarGrafo")

        self.pbLimpiarGrafo = QPushButton(self.tab3)
        self.pbLimpiarGrafo.setText(u"Limpiar")
        self.pbLimpiarGrafo.setObjectName(u"pbLimpiarGrafo")

        self.gridlayoutTab3.addWidget(self.gvParticula, 0, 0, 1, 2)
        self.gridlayoutTab3.addWidget(self.pbMostrarGrafo, 1, 0, 1, 1)
        self.gridlayoutTab3.addWidget(self.pbLimpiarGrafo, 1, 1, 1, 1)
################################################################################ Tab3 (fin)
